...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  useEffect(() => {
    localStorage.setItem("sidebar-expanded", sidebarExpanded && sidebarExpanded.toString());
    if (sidebarExpanded) {
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/doctors" || pathname.includes("doctors")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`first-letter:group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/doctors/Dr Juan Carlos" &&
                                "text-white"
                              }`}
                            >
                              Dr Juan Carlos
                          ...
                          <li>
                            <Link
                              href="/doctors/Dra Maria Gutierrez"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/doctors/Dra Maria Gutierrez" &&
                                "text-white"
                              }`}
                            >
                              Dra. Maria Gutierrez
